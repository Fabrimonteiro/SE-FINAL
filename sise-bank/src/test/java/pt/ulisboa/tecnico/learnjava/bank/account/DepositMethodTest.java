...
public class DepositMethodTest {
	...
	public void setUp() throws AccountException, ClientException, BankException {
		...
		Person person = new Person("JosÃ©", "Manuel","Street", 33);
		Person youngPerson = new Person("José", "Santos","StreetCity", 17);

		Client client = new Client(bank, "123456789", "987654321", person );
