...
public class ExamTests {
	...
	public void setUp() throws AccountException, ClientException, BankException {
		...
		Person person1 = new Person("José", "Manuel","Street", 33);
		Person person2 = new Person("José", "Manuel","Street", 33);
		Person youngPerson = new Person("Jos�", "Santos","StreetCity", 17);

		Client client1 = new Client(bank, "123456789", "987654321", person1 );
		Client youngClient = new Client(bank,  "123456780", "987654321", youngPerson);
		
		Client client2 = new Client(bank, "284728192", "987654321", person2 );

		this.checking = (CheckingAccount) this.services
				.getAccountByIban(this.bank.createAccount(Bank.AccountType.CHECKING, this.client1, 0, 0));

		this.otherChecking = (CheckingAccount) this.services
				.getAccountByIban(this.bank.createAccount(Bank.AccountType.CHECKING, client2, 100, 0));

		this.savings = (SavingsAccount) this.services
				.getAccountByIban(this.bank.createAccount(Bank.AccountType.SAVINGS, this.client1, 100, 10));
		...
		this.salary = (SalaryAccount) this.services
				.getAccountByIban(this.bank.createAccount(Bank.AccountType.SALARY, this.client1, 0, 1000));
	}
	...
	public void clientHasOneActiveAndTwoInactive() throws AccountException {
		...
		assertFalse(this.client1.isInactive());
	}
	...
	public void clientHasAllThreeInactive() throws AccountException {
		...
		assertTrue(this.client1.isInactive());
	}
	...
	public void countNumberOfInactiveAccountsForClientThatHasOneActiveAndTwoInactive() throws AccountException {
		...
		assertEquals(2, this.client1.numberOfInactiveAccounts());
	}
	...
	public void countNumberOfInactiveAccountsForClientThatHasAllThreeInactive() throws AccountException {
		...
		assertEquals(3, this.client1.numberOfInactiveAccounts());
	}
