...
public class Bank {
	...
	public static void main(String[] args) throws BankException, AccountException, ClientException {
		...
		Person personOne = new Person("JosÃ©", "Manuel","Street", 33);
		Person personTwo = new Person("José", "Santos","StreetCity", 17);

		Client clientOne = new Client(cgd,  "123456789", "987654321", personOne);
		Client clientTwo = new Client(cgd, "123456780", "987654321", personTwo);
